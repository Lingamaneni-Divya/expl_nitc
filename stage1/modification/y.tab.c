...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 22 "m2.y" /* yacc.c:1646  */
    {    printf("tree generated!!!\n");
			printf("postfix notation\n");
			postfix((yyval.no));printf("\n");
			printf("prefix notation\n");
			prefix((yyval.no));printf("\n");
			printf("infix notation\n");
                        infix((yyval.no));printf("\n");
			printf("infix of sqaures\n");
			infixsquare((yyval.no));printf("\n");
			int r;
   			r =codegen((yyval.no));
			freereg();
			printf("Expression value:\n");
			scall("Write",-2,4096);
			r =codegen_sos((yyval.no));
			freereg();
