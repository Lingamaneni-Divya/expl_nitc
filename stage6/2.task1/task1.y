...
Body	:PBEGIN Slist RetStmt PEND';' 
	...
	;
RetStmt	:RETURN expr ';' {printf("tree call 2:\n");typecheck($2);$$=create_tree(0,$2->type,func_name,ret_node,$2,NULL,NULL); }
	;
...
InputStmt:READ '('VAR')'';'	{printf("tree call 6:\n");typecheck($3);$$=create_tree(0,TLookup("null"),NULL,read_node,$3,NULL,NULL); }
	 |READ '('Sarray')'';'	{printf("tree call 7:\n");typecheck($3);$$=create_tree(0,TLookup("null"),NULL,read_node,$3,NULL,NULL); }
	 |READ '('Field')'';'	{printf("tree call 8:\n");typecheck($3);$$=create_tree(0,TLookup("null"),NULL,read_node,$3,NULL,NULL); }
	;
OutputStmt:WRITE '('expr')' ';'	{printf("tree call 9:\n");typecheck($3);$$=create_tree(0,TLookup("null"),NULL,write_node,$3,NULL,NULL); }
	  ;
AssgStmt:VAR '=' expr ';'	{
				printf("lex:\n");printf("before:");print_node($1);print_node($3);typecheck($1);typecheck($3);
...
expr	:expr PLUS expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 21:\n");	$$=create_tree(0,TLookup("int"),"+",aop_node,$1,NULL,$3); 
				}	
	|expr MINUS expr	{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 22:\n");	$$=create_tree(0,TLookup("int"),"-",aop_node,$1,NULL,$3); }
	|expr MUL expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 23:\n");	$$=create_tree(0,TLookup("int"),"*",aop_node,$1,NULL,$3); }
	|expr DIV expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 24:\n");	$$=create_tree(0,TLookup("int"),"/",aop_node,$1,NULL,$3); }
	|expr MOD expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 25:\n");	$$=create_tree(0,TLookup("int"),"%",aop_node,$1,NULL,$3); }
		
	|expr LE expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 26:\n");	$$=create_tree(0,TLookup("bool"),"<=",lop_node,$1,NULL,$3); }
	|expr GE expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 27:\n");	$$=create_tree(0,TLookup("bool"),">=",lop_node,$1,NULL,$3); }
	|expr LT expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 28:\n");	$$=create_tree(0,TLookup("bool"),"<",lop_node,$1,NULL,$3); }
	|expr GT expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 29:\n");	$$=create_tree(0,TLookup("bool"),">",lop_node,$1,NULL,$3); }
	|expr EE expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 30:\n");	$$=create_tree(0,TLookup("bool"),"==",lop_node,$1,NULL,$3); }
	|expr NE expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 31:\n");	$$=create_tree(0,TLookup("bool"),"!=",lop_node,$1,NULL,$3); }

	|expr ANDTK expr        {printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 32:\n");	$$=create_tree(0,TLookup("bool"),"&&",lop_node,$1,NULL,$3); }
	|expr ORTK expr		{printf("lex:\n");printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				printf("tree call 33:\n");	$$=create_tree(0,TLookup("bool"),"||",lop_node,$1,NULL,$3); }
	|    NOTTK expr		{printf("lex:\n");printf("before:");print_node($2);
				typecheck($2);printf("after:");print_node($2);
...
ArgList	: ArgList','expr	{$3->middle=$1;printf("lex arglist:\n"); printf("before:");print_node($1);print_node($3);
				typecheck($1);typecheck($3);printf("after:");print_node($1);print_node($3);
				  $$=$3;
					}
	|expr			{$$=$1;printf("lex:\n"); printf("before:");print_node($1);
